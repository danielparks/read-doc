...
fn test_include_module_docs_output() {
    let docs: &str = include_module_docs!("fruit/apple.rs");
    assert_eq!(
        docs,
...
fn test_include_docs_combines_files() {
    let docs: &str = include_docs!("fruit/apple.rs", "fruit/orange.rs");
    ...
    assert!(
        docs.contains("Various orange-related"),
        "Missing orange content"
    );
...
fn test_block_docs_output() {
    let docs: &str = include_module_docs!("doc_formats/block_docs.rs");
...
fn test_attr_docs_output() {
    let docs: &str = include_module_docs!("doc_formats/attr_docs.rs");
    assert_eq!(
        docs,
...
fn test_all_doc_formats() {
    let line_docs: &str = include_module_docs!("doc_formats/line_docs.rs");
    let block_docs: &str = include_module_docs!("doc_formats/block_docs.rs");
    let attr_docs: &str = include_module_docs!("doc_formats/attr_docs.rs");
...
fn test_empty_docs() {
    ...
    let docs: &str = include_module_docs!("no_inner_docs.rs");
    assert_eq!(docs, "");
}
